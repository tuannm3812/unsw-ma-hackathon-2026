...
**Deck v2 (2026-09-04).** The refined deck applies the verified edit list (`docs/presentation/deck_edit_list.md`): the headline slide's within-region table now shows the **authoritative fit**, so quote urgency's collapse as **p ≈ 0.49** (authoritative duration; 0.44 was the notebook fit), and the borrower page is reframed as expectations, not tactics. The scripts and exhibits below match v2.
