...
# The deck AS PRESENTED (v2, resubmitted 2026-09-04) kept the notebook fit
# on this slide, so this exhibit matches it and the title says which fit it
# is. The authoritative pipeline's slopes (association_summary.txt) agree in
# direction and conclusion in every row; the deck's A1 appendix quotes that
# fit's screen values. Compact 6-column layout so the table fits its placed
# 4.55in at full 10pt type (3-dp rounding; 4-dp values live in SS7.2).
