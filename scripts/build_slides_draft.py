...
SLIDES = [
 ...
 ("What survives scrutiny", None,
  ...
  ["Urgency: looked universal (p<0.001) — collapses under country clustering (p≈0.49). Not recommended.",
